...
| UI | React 19 |
| Chain | wagmi 3 + viem 2 (X Layer Testnet) |
...
Connect a wallet on **X Layer Testnet (1952)**. The Nav prompts a network switch if you're on the wrong chain.

## Environment

| Var | Required | Purpose |
|---|---|---|
| `NEXT_PUBLIC_RPC_URL` | optional | Private X Layer RPC. Falls back to the public `https://testrpc.xlayer.tech` (rate-limited; caps `getLogs` at 100 blocks). |
...
components/
  home/                   Masthead · Pillars · Mechanics · Architecture · VsTable · Deployed · References
